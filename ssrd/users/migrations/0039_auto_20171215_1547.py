...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='type',
            field=models.SmallIntegerField(choices=[(0, '全部文档'), (1, '说明文档'), (2, '常用软件'), (3, '设计方案'), (4, '签证'), (5, '项目材料')], default=1, verbose_name='文件类型'),
        ),
        migrations.AlterField(
            model_name='group',
            name='name',
        ...
        migrations.AlterField(
            model_name='project',
            name='type',
            field=models.CharField(choices=[('create', '新建项目'), ('maintain', '故障维护'), ('remove', '迁移、拆除'), ('exhibition', '展会协助')], default=0, max_length=20, verbose_name='项目类型'),
        ),
        migrations.AddField(
            model_name='project',
            name='group',
