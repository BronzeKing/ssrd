    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('新建项目', '新建项目'), ('故障维护', '故障维护'), ('迁移、拆除', '迁移、拆除')], default=0, max_length=20, verbose_name='项目类型')),
                ...
                ('linkman', models.CharField(max_length=50, unique=True, verbose_name='联系人')),
